...
namespace ExtenderApp.Abstract
{
    ...
    /// </summary>
    /// <typeparam name="TLinkClient">要创建的客户端类型，必须实现 <see cref="ILinkChannel"/>。</typeparam>
    public interface ILinkClientFactory<TLinkClient> : ILinkClientFactory where TLinkClient : ILinkChannel
    {
        /// <summary>
