...
namespace ExtenderApp.Abstract
{
    ...
    public interface IFileParser
    {
        ...
        /// <returns>如果序列化成功，则返回true；否则返回false。</returns>
        bool Serialize<T>(FileOperateInfo operate, T value, object? options = null);
        ...
        ValueTask<bool> SerializeAsync<T>(FileOperateInfo operate, T value, object? options = null);
        ...
        T? Deserialize<T>(FileOperateInfo operate, object? options = null);
        ...
        ValueTask<T?> DeserializeAsync<T>(FileOperateInfo operate, object? options = null);
    }
}
