...
namespace ExtenderApp.Abstract
{
    ...
    public interface IBinaryParser : IFileParser
    {
        ...
        /// <summary>
        /// 将指定类型的值序列化到给定的<see cref="ByteBuffer"/>对象中。
        /// </summary>
        /// <typeparam name="T">要序列化的值的类型。</typeparam>
        /// <param name="block"><see cref="ByteBuffer"/>对象，用于写入序列化后的数据。</param>
        /// <param name="value">要序列化的值。</param>
        void Serialize<T>(ref ByteBuffer block, T value);
        ...
        /// <param name="compression">压缩类型</param>
        void ToLz4(in ReadOnlySequence<byte> readOnlyMemories, ref ByteBuffer block, CompressionType compression);
