...
namespace ExtenderApp.Abstract
{
    ...
    public interface ILinkReceiver
    {
        ...
        Result<LinkOperationValue> Receive(Span<byte> span);
        ...
        /// <returns>一个包含 <see cref="LinkOperationValue"/> 的 <see cref="Result{T}"/> 实例。</returns>
        Result<LinkOperationValue> Receive(Span<byte> span, LinkFlags flags);
        ...
        /// <param name="flags">接收标志。</param>
        /// <returns>一个包含 <see cref="LinkOperationValue"/> 的 <see cref="Result{T}"/> 实例。</returns>
        Result<LinkOperationValue> Receive(Memory<byte> memory, LinkFlags flags);
        ...
        /// <returns>一个包含 <see cref="LinkOperationValue"/> 的 <see cref="Result{T}"/> 实例。</returns>
        Result<LinkOperationValue> Receive(IList<ArraySegment<byte>> buffer);
        ...
        /// <param name="flags">接收标志。</param>
        /// <returns>一个包含 <see cref="LinkOperationValue"/> 的 <see cref="Result{T}"/> 实例。</returns>
        Result<LinkOperationValue> Receive(IList<ArraySegment<byte>> buffer, LinkFlags flags);
        ...
        /// </returns>
        ValueTask<Result<LinkOperationValue>> ReceiveAsync(Memory<byte> memory, CancellationToken token = default);
        ...
        ValueTask<Result<LinkOperationValue>> ReceiveAsync(Memory<byte> memory, LinkFlags flags, CancellationToken token = default);
        ...
        ValueTask<Result<LinkOperationValue>> ReceiveAsync(IList<ArraySegment<byte>> buffer, CancellationToken token = default);
        ...
        /// <param name="token">用于取消异步操作的令牌。</param>
        /// <returns>一个表示异步操作的 <see cref="ValueTask{TResult}"/>。</returns>
        ValueTask<Result<LinkOperationValue>> ReceiveAsync(IList<ArraySegment<byte>> buffer, LinkFlags flags, CancellationToken token = default);
