...
{
    /// <summary>
    /// HostServiceExtensions 类，提供扩展方法来向 HostApplicationBuilder 添加服务执行器。
    /// </summary>
    internal static class HostServiceExtensions
    {
        /// <summary>
        /// 向 HostApplicationBuilder 添加 HostedServiceExecutor 服务执行器。
        /// </summary>
        /// <param name="builder">HostApplicationBuilder 实例。</param>
        /// <returns>返回修改后的 HostApplicationBuilder 实例。</returns>
