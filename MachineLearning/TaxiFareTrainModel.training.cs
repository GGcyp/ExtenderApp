...
{
    public partial class TaxiFareTrainModel
    {
        public const string RetrainFilePath =  @"E:\WPF_Project\ExtenderApp\MachineLearning\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=662,NumberOfIterations=3237,MinimumExampleCountPerLeaf=20,LearningRate=0.9999997766729865,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.09452704848614155,FeatureFraction=0.9963332214516898,L1Regularization=5.960446399528558E-10,L2Regularization=0.47966532915753146},MaximumBinCountPerFeature=235}));
