...
namespace ExtenderApp.Data.Buffer
{
    ...
    public class SequenceBuffer<T> : BufferBase<T>
    {
        /// <summary>
        /// 自动增长的最大大小。
        /// </summary>
        ...
        internal SequenceBufferPool<T> OwnerPool;
        ...
        public void Append(SequenceBufferSegment<T> segment)
        {
            ...
            SequenceBufferSegment<T>.ReleaseSegment(Last);
            Last = segment;
        }
        ...
        protected override void ReleaseProtected() => OwnerPool.Release(this);

        public override void Clear()
        {
            SequenceBufferSegment<T>.ReleaseSegment(First);
            First = null;
            Last = null;
