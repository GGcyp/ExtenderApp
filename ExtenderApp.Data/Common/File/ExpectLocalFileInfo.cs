namespace ExtenderApp.Data
{
    ...
    public struct ExpectLocalFileInfo : IEquatable<ExpectLocalFileInfo>
    {
        ...
        public FileOperate CreateFileOperate(string extension, FileMode fileMode = FileMode.Open, FileAccess fileAccess = FileAccess.Read)
        {
        ...
        public FileOperate CreateWriteOperate(string extension)
        {
