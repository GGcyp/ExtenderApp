...
namespace ExtenderApp.Data
{
    ...
    public static class FileOperateExtensions
    {
        ...
        /// 将当前文件移动到指定目标文件对象。
        /// </summary>
        /// <param name="operate">要移动的文件操作对象。</param>
        ...
        public static void Move(this FileOperate operate, FileOperate targetOperate)
        {
        ...
        /// <exception cref="InvalidOperationException">如果目标文件已存在。</exception>
        public static void Move(this FileOperate operate, LocalFileInfo localFileInfo)
        {
        ...
        public static void Move(this FileOperate operate, string targetPath)
        {
        ...
        public static void Delete(this FileOperate operate)
        {
