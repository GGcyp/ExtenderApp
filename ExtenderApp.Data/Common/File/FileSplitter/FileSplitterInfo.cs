...
namespace ExtenderApp.Data
{
    ...
    public class FileSplitterInfo
    {
        ...
        public FileSplitterInfo(long length, uint chunkCount, uint progress, int maxChunkSize, string targetExtensions) : this(length, chunkCount, progress, maxChunkSize, targetExtensions, new byte[chunkCount])
        {
        ...
        public FileSplitterInfo(long length, uint chunkCount, uint progress, int maxChunkSize, string targetExtensions, byte[] loadedChunks)
        {
            Length = length;
        ...
        public bool Equals(FileSplitterInfo other)
        {
