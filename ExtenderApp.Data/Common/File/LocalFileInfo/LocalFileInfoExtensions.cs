namespace ExtenderApp.Data.Common.File
{
    /// <summary>
    ...
    public static class LocalFileInfoExtensions
    {
        ...
        /// <param name="targetOperate">目标操作，包含目标文件信息</param>
        ...
        public static void Move(this LocalFileInfo info, FileOperate targetOperate)
        {
