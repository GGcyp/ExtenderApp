...
namespace ExtenderApp.Data
{
        ...
        where T : unmanaged, IEquatable<T>
    {
        ...
        public Block(SequencePool<T> pool)
        {
            rental = pool.Rent();
        ...
        public Block(Sequence<T> sequence) : this(readOnlySequence: sequence)
        {
            _sequence = sequence;
        }
        ...
        public Block(ReadOnlyMemory<T> memory) : this(readOnlySequence: new(memory))
        {
        }
        ...
        public Block(ReadOnlySequence<T> readOnlySequence)
        {
        ...
        {
            var span = _sequence!.GetSpan(sizeHint);
            readerDirty = true;
            return span;
        }
        ...
        {
            Memory<T> memory = _sequence!.GetMemory(sizeHint);
            readerDirty = true;
            return memory;
        }
        ...
        /// </summary>
        public Block<T> CreatePeekBlock() => this;
