...
namespace ExtenderApp.Buffer
{
    public static class AbstractBufferExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Write<T>(this AbstractBuffer<byte> memories, T value, out int size, bool isBigEndian = true)
            where T : unmanaged
        {
            ArgumentNullException.ThrowIfNull(memories, nameof(memories));
            size = Marshal.SizeOf<T>();
            var span = memories.GetSpan(size);
            if (span.Length < size)
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryWrite<T>(this AbstractBuffer<byte> memories, T value, out int size, bool isBigEndian = true)
            where T : unmanaged
        {
            if (memories is null)
            {
        ...
        public static T Read<T>(this AbstractBuffer<byte> memories, bool isBigEndian = true)
            where T : unmanaged
        {
            return memories.Read<T>(out _, isBigEndian);
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(memories, nameof(memories));
            return Read<T>(memories.CommittedSequence, out size, isBigEndian);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryRead<T>(this AbstractBuffer<byte> memories, out T value, out int size, bool isBigEndian = true)
            where T : unmanaged
        {
            ArgumentNullException.ThrowIfNull(memories, nameof(memories));
            return TryRead(memories.CommittedSequence, out value, out size, isBigEndian);
        }
