...
namespace ExtenderApp.Media.FFmpegEngines
{
    ...
    public struct FFmpegDecoderContext
    {
        ...
        /// 空实例，所有指针均为 Empty。
        /// </summary>
        public static FFmpegDecoderContext Empty => new(NativeIntPtr<AVCodec>.Empty, NativeIntPtr<AVCodecParameters>.Empty, NativeIntPtr<AVCodecContext>.Empty, NativeIntPtr<AVStream>.Empty, -1);
        ...
        public FFmpegDecoderContext(NativeIntPtr<AVCodec> codec, NativeIntPtr<AVCodecParameters> codecParameters, NativeIntPtr<AVCodecContext> codecContext, NativeIntPtr<AVStream> stream, int streamIndex)
        {
            Codec = codec;
