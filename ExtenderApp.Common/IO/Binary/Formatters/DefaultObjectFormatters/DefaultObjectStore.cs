...
namespace ExtenderApp.Common.IO.Binary.Formatters
{
    ...
    internal class DefaultObjectStore
    {
        ...
        public DefaultObjectStore(IBinaryFormatterResolver resolver)
        {
            ...
            serializeParameter = Expression.Parameter(typeof(ByteBuffer).MakeByRefType(), "write");
            deserializeParameter = Expression.Parameter(typeof(ByteBuffer).MakeByRefType(), "read");
        }
