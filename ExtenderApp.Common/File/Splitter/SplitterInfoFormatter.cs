...
namespace ExtenderApp.Common.File.Splitter
{
    ...
    /// 文件分割信息格式化器类
    /// </summary>
    internal class SplitterInfoFormatter : ResolverFormatter<FileSplitterInfo>
    {
        /// <summary>
        /// 用于反序列化 long 类型的格式化器
        /// </summary>
        ...
        public override FileSplitterInfo Deserialize(ref ExtenderBinaryReader reader)
        {
            ...
            return new FileSplitterInfo(length, chunkCount, progresst, maxChunkSize, targetExtensions, bytes);
        }
        ...
        public override void Serialize(ref ExtenderBinaryWriter writer, FileSplitterInfo value)
        {
        ...
        public override int GetCount(FileSplitterInfo value)
        {
            if (value == null)
            {
