...
{
    /// <summary>
    /// 提供用于配置和操作 <see cref="ILinker"/> 与 <see cref="ILinkChannel"/> 的 DI 扩展方法集合。
    /// </summary>
    internal static class LinkClientExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TLinkClient">要注册的链接客户端实现类型，必须实现 <see cref="ILinkChannel"/>。</typeparam>
        ...
        public static IServiceCollection AddLinkClient<TLinkClient, TLinkClientFactory>(this IServiceCollection services)
            where TLinkClient : class, ILinkChannel
