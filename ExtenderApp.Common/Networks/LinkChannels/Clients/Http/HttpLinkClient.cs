...
namespace ExtenderApp.Common.Networks.LinkChannels
{
    ...
    /// </summary>
    internal class HttpLinkClient : LinkChannel, IHttpLinkClient, IValueTaskSource<HttpResponseMessage>, IDisposable
    {
        /// <summary>
        ...
        public ValueTask<HttpResponseMessage> SendAsync(HttpRequestMessage request, SslClientAuthenticationOptions? options = null, CancellationToken token = default)
        {
            ...
            //    {
            //        request.Method = Contracts.HttpMethod.GetAwaitableEventSource;
