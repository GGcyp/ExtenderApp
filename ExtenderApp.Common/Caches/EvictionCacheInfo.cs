...
namespace ExtenderApp.Common.Caches
{
    ...
    /// </summary>
    public class EvictionCacheInfo : IResettable
    {
        /// <summary>
        /// 静态对象池，用于复用EvictionCacheInfo对象
        /// </summary>
        private static readonly ObjectPool<EvictionCacheInfo> _pool
            = ObjectPool.CreateDefaultPool<EvictionCacheInfo>();

        /// <summary>
        /// 从对象池中获取EvictionCacheInfo对象
        /// </summary>
        /// <returns>从对象池中获取的EvictionCacheInfo对象</returns>
        public static EvictionCacheInfo Get() => _pool.Get();

        /// <summary>
        /// 将EvictionCacheInfo对象释放回对象池
        /// </summary>
        /// <param name="info">需要释放的EvictionCacheInfo对象</param>
        public static void Release(EvictionCacheInfo info) => _pool.Release(info);
