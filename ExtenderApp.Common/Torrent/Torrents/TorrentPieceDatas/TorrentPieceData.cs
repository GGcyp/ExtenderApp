        ...
        private void InitializeSegments()
        {
            ...
            foreach (var node in fileInfoNode)
            {
                ...
                if (currentSegment != null && currentSegmentOffset < _nodeParent.PieceLength)
                {
                    ...
                    long lengthToAdd = System.Math.Min(remainingFileLength, spaceInCurrentSegment);
                ...
                while (remainingFileLength > 0)
                {
                    ...
                    long lengthToAdd = System.Math.Min(remainingFileLength, _nodeParent.PieceLength);
