...
namespace AppHost.Extensions.DependencyInjection
{
    ...
    public static class ServiceDescriptorFactory
    {
        ...
        public static ExtenderServiceDescriptor Create(Type serviceType, Type implementationType, ServiceLifetime lifetime)
        {
        ...
        /// <returns>返回创建的服务描述符。</returns>
        /// <exception cref="NotImplementedException">如果生命周期不匹配，则抛出此异常。</exception>
        public static ExtenderServiceDescriptor Create(Type serviceType, Func<IServiceProvider, object> factory, ServiceLifetime lifetime)
        {
            return lifetime switch
            {
        ...
        /// <returns>返回创建的服务描述符。</returns>
        /// <exception cref="NotImplementedException">如果生命周期不匹配，则抛出此异常。</exception>
        public static ExtenderServiceDescriptor Create(Type serviceType, Func<IServiceProvider, object?, object> factory, ServiceLifetime lifetime)
        {
            return lifetime switch
            {
                ServiceLifetime.Singleton => new ServiceDescriptor(serviceType, factory, lifetime),
