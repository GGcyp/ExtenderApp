...
namespace ExtenderApp.Torrent
{
    ...
    {
        public TorrentMainViewModel(IHashProvider provider, LinkClient<IUdpLinker, UdpTrackerParser> client, LocalTorrentInfo localTorrentInfo, IServiceStore serviceStore) : base(serviceStore)
        {
            ...
            TorrentFileForamtter torrentFileForamtter = new TorrentFileForamtter(provider);
